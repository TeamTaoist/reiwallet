        ...
        <div>
            ...
            <AmountBox>
                ...
                <div className="rht">
                    ...
                    <div className="balance">Amount: <span>{balance}</span></div>
                </div>
            </AmountBox>
        </div>
            ...
            <Gas>
                <div className="item">
                    <WhiteInput>
                        ...
                        <div className="num"><span>{fee?fee:"--"}</span> Shannons/kB</div>
                    </WhiteInput>
                </div>
            </Gas>
        <TokenBox>
            ...
            <Button primary disabled={amount<=0 || !address?.length}  onClick={()=>submit()}>Send</Button>
        </BtnGroup>
    </ContentBox>
    </Box>
}
