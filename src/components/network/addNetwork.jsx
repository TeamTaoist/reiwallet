...
export default function AddNetwork() {
  ...
  return (
    <Box>
      ...
      <BtnGroup>
        <Button border onClick={() => toGo()}>
          {t("popup.network.cancel")}
        </Button>
        <Button primary onClick={() => submit()}>
          {t("popup.network.save")}
        </Button>
      </BtnGroup>
    </Box>
  );
