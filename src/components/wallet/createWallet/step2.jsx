...
export default function Step2(){
    ...
    return <Box>
        ...
        <CreateHeader title={t('popup.step2.subTitle')} step="2/3" tips={t('popup.step2.tips')} />
        <MainBox>
            ...
            <CreateBox>
                ...
                <CopyBox>
                    ...
                    <CopyToClipboard onCopy={()=>Copy()} text={mnemonicStr.join(" ")}>
                        <StrBox><img src={CopyImg} alt=""/> Copy to Clipboard</StrBox>
                    </CopyToClipboard>
                </CopyBox>
            </CreateBox>

            <BtmBox>
                <Button fullWidth primary onClick={()=>submit()}>{t('popup.step2.Next')}</Button>
            </BtmBox>
