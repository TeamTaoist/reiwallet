...
export default function Step1() {
  ...
  return (
    <div>
      ...
      <Content>
        <dl>
          <dt className="titleTips regular-font">
            {t("popup.step1.walletName")}
          </dt>
          <dd className="inputBox">
            <input
              type="text"
              placeholder={t("popup.step1.namePlaceholder")}
              value={walletName}
        ...
        <dl>
          ...
          <dd className="inputBox">
            <input
              ...
              placeholder={t("popup.step1.pwdPlaceholder")}
              value={password}
        ...
        <dl>
          <dt className="titleTips regular-font">
            {t("popup.step1.confirmPwd")}
          </dt>
          <dd className="inputBox">
            <input
              type={showConfirm ? "password" : "text"}
              placeholder={t("popup.step1.confirmPlaceholder")}
              value={confirmPassword}
              onChange={(e) => handleInput(e, "confirmPassword")}
              autoComplete="new-password"
            />
            {!showConfirm && (
              <img src={Close} alt="" onClick={() => switchConfirmPwd()} />
            )}
            {showConfirm && (
              <img src={Open} alt="" onClick={() => switchConfirmPwd()} />
            )}
          </dd>
        </dl>
        <TipsBox>
          <img src={TipImg} alt="" />
          <div className="regular-font">{t("popup.step1.tips")}</div>
        </TipsBox>
        <BtnGroup>
