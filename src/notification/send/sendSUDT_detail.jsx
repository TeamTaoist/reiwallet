...
export default function SendSUDT_detail(){
    ...
    const handleSuccess = async(rt) =>{
        try{
            await messenger.send('SUDT_transaction_result', {status:"success",data:rt});

        }catch (e) {
            console.error('transaction_result',e)
            await messenger.send('SUDT_transaction_result', {status:"failed",data:e.message});
        }finally {
            setLoading(false)
        }
    }
    ...
    const handleClose = async() =>{
        await messenger.send('SUDT_transaction_result', {status:"rejected",data:"user rejected"});
        window.close();
    }
